		...
		<TR>
			...
			<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="3">
				<TR>
					...
					<xsl:apply-templates select="./pa[@idl='1']/mi[@flag = 'QUAL']" />
					<xsl:apply-templates select="./pa[@idl='1']/mi[@flag = 'PICK_ELEM']" />
					<xsl:apply-templates select="./pa[@idl='1']/mi[@flag = 'PICK_QUAL']" />
					...
					<xsl:when test="./pa[@idl='1']/mi[@flag = 'PICK_QUAL']">
						<TD ALIGN="CENTER">
							<!--
							<INPUT TYPE="IMAGE" SRC="Images/btn_add.gif" WIDTH="25" HEIGHT="25" BORDER="0">
								<xsl:attribute name="ALT"><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_537").text</xsl:eval></xsl:attribute>
							...
							-->
							<IMG TYPE="IMAGE" SRC="Images/btn_add.gif" WIDTH="25" HEIGHT="25" BORDER="0">
								<xsl:attribute name="ALT"><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_537").text</xsl:eval></xsl:attribute>
								<xsl:attribute name="NAME">Add_<xsl:value-of select="./@pin" /></xsl:attribute> 
							</IMG>
							<BR />
							...
							<xsl:when expr="this.selectSingleNode('/mi/inputs/DHTML').text=='1'">
								<A>
								<xsl:attribute name="HREF">javascript:RemoveItemsbyListObjectForHIInList(document.PromptForm.Selected_<xsl:value-of select="./@pin" />, document.PromptForm.Available_<xsl:value-of select="./@pin" />, document.PromptForm.Attribute_<xsl:value-of select="./@pin" />, '<xsl:value-of select="ancestor(pif)/@pin" />' )</xsl:attribute>
									<IMG SRC="Images/btn_remove.gif" WIDTH="25" HEIGHT="25" BORDER="0">					
										<xsl:attribute name="ALT"><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_875").text</xsl:eval></xsl:attribute> 
										<xsl:attribute name="NAME">Remove_<xsl:value-of select="./@pin" /></xsl:attribute> 
									</IMG>
					...
					<xsl:when test="./pa[@idl='1']/mi[@flag = 'QUAL']">
						<TD ALIGN="CENTER">
							<xsl:choose>
							<xsl:when expr="this.selectSingleNode('/mi/inputs/DHTML').text=='1'">
								<A>
								<xsl:attribute name="HREF">javascript:AddItemsbyListObjectForExpression(document.PromptForm.Attribute_<xsl:value-of select="./@pin" />, document.PromptForm.Operator_<xsl:value-of select="./@pin" />, document.PromptForm.Input_<xsl:value-of select="./@pin" />, document.PromptForm.Selected_<xsl:value-of select="./@pin" />, '<xsl:value-of select="./@pin" />')</xsl:attribute>
									<IMG SRC="Images/btn_add.gif" WIDTH="25" HEIGHT="25" BORDER="0" >
										<xsl:attribute name="ALT"><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_537").text</xsl:eval></xsl:attribute> 
										<xsl:attribute name="NAME">Add_<xsl:value-of select="./@pin" /></xsl:attribute> 
									</IMG>
								...
								<BR />
								<A>
								<xsl:attribute name="HREF">javascript:RemoveItemsbyListObjectForHIInQual(document.PromptForm.Selected_<xsl:value-of select="./@pin" />, document.PromptForm.Operator_<xsl:value-of select="./@pin" />, document.PromptForm.Attribute_<xsl:value-of select="./@pin" />, '<xsl:value-of select="./@pin" />')</xsl:attribute>
									<IMG SRC="Images/btn_remove.gif" WIDTH="25" HEIGHT="25" BORDER="0">					
										<xsl:attribute name="ALT"><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_875").text</xsl:eval></xsl:attribute> 
										<xsl:attribute name="NAME">Remove_<xsl:value-of select="./@pin" /></xsl:attribute>
 									</IMG>
...
<xsl:template match="./pa[@idl='1']/mi[@flag = 'PICK_ELEM' $or$ @flag = 'PICK_QUAL']" >
		...
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%" BGCOLOR="#000000"><TR><TD>
			<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%" BGCOLOR="#FFFFFF">
				<TR>
					...
					<TD WIDTH="2"><IMG SRC="Images/1ptrans.gif" WIDTH="2" HEIGHT="1" ALT="" BORDER="0" /></TD>
					<TD BGCOLOR="#AAAA77" NOWRAP="1"><IMG SRC="Images/1ptrans.gif" HEIGHT="13" WIDTH="2" ALT="" BORDER="0" /><B><FONT COLOR="#666666"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_546").text</xsl:eval><BR /></FONT></B></TD>
				</TR>
		...
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%" BGCOLOR="#000000"><TR><TD>
				...
				<TR>
					...
					<xsl:choose>
						<xsl:when test=".//oi[@tp='12' $and$ ./ad[@iep='1']]" >
							<TD BGCOLOR="#CCCC99" NOWRAP="1"><INPUT TYPE="IMAGE" SRC="Images/arrow_right.gif" WIDTH="13" HEIGHT="13" ALT="" BORDER="0"><xsl:attribute name="NAME">qualify_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute></INPUT
								><B><FONT COLOR="#000000"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_546").text</xsl:eval><BR /></FONT></B
							></TD>
						</xsl:when>
						<xsl:otherwise>
							<TD BGCOLOR="#CCCC99" NOWRAP="1"><IMG SRC="Images/arrow_right_disabled.gif" WIDTH="13" HEIGHT="13" ALT="" BORDER="0"
								/><B><FONT COLOR="#999999"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_546").text</xsl:eval><BR /></FONT></B
							></TD>
						</xsl:otherwise>
					</xsl:choose>
				</TR>
			...
			<TD>
				...
				<xsl:choose>
					...
					<xsl:when test=".//oi[@tp='12' $and$ @highlight='1']/es" >
					...
					<xsl:otherwise>
						...
						<TR>
							<TD>
							<BR />
							<FONT COLOR="#000000"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_552").text</xsl:eval><BR /></FONT>
							<FONT COLOR="#000000"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_553").text</xsl:eval><BR /></FONT>
							</TD>
						</TR>	
						</TABLE>
					</xsl:otherwise>					
				...
				<xsl:if test=".[.//oi[@tp='12' $and$ ./ad[@iep='1']]]" >
					...
					<xsl:if test=".//oi[@tp='14' $and$ @highlight='1']/mi/oi[1]">
						<xsl:apply-templates select=".//oi[@tp='14' $and$ @highlight='1']/mi/oi[@highlight='1']/ad" />
					</xsl:if>
				</xsl:if>
...
<xsl:template match="./pa[@idl='1']/mi[@flag = 'QUAL']" >
	...
	<TD VALIGN="TOP" NOWRAP="1">
		<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="1" WIDTH="100%" BGCOLOR="#000000"><TR><TD>
			<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%" BGCOLOR="#FFFFFF">
				<TR>
					<TD BGCOLOR="#CCCC99" NOWRAP="1"><INPUT TYPE="IMAGE" SRC="Images/arrow_right.gif" WIDTH="13" HEIGHT="13" ALT="" BORDER="0"><xsl:attribute name="NAME">list_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute></INPUT
						><B><FONT COLOR="#000000"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_547").text</xsl:eval><BR /></FONT></B
						></TD>
					<TD WIDTH="2"><IMG SRC="Images/1ptrans.gif" WIDTH="2" HEIGHT="1" ALT="" BORDER="0" /></TD>
					<TD BGCOLOR="#CCCC99" NOWRAP="1"><IMG SRC="Images/arrow_down.gif" WIDTH="13" HEIGHT="13" ALT="" BORDER="0" /><B><FONT COLOR="#CC0000"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_546").text</xsl:eval><BR /></FONT></B></TD>
				</TR>
					...
					<TD VALIGN="TOP" COLSPAN="4">
						...
						<NOBR>
							<SELECT>
								...
								<xsl:choose>
									<xsl:when expr="this.selectSingleNode('/mi/inputs/DHTML').text=='1'">
										<xsl:attribute name="ID">Attribute_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute>
										<xsl:attribute name="onChange">showOrHideCalendarButton('Attribute_<xsl:value-of select='ancestor(pif)/@pin' />','Calendar_button_<xsl:value-of select='ancestor(pif)/@pin' />');</xsl:attribute>
									</xsl:when>
								</xsl:choose>
								<xsl:choose>
									<xsl:when test=".//oi[@tp='12' $and$ ./ad[@iep='1']]" >
							 		<xsl:for-each select=".//oi[@tp='12' $and$ ./ad[@iep='1']]" >	
										...
										<OPTION>
											...
											<xsl:attribute name="VALUE"><xsl:value-of select="context(-2)/@did" /><xsl:eval no-entities="1">RS</xsl:eval><xsl:value-of select="./@did" /><xsl:eval no-entities="1">RS</xsl:eval><xsl:value-of select="context(-2)/@disp_n" /><xsl:eval no-entities="1">RS</xsl:eval><xsl:value-of select="./@disp_n" /><xsl:eval no-entities="1">RS</xsl:eval><xsl:value-of select="./@ddt" /></xsl:attribute>
											<xsl:value-of select="context(-2)/@disp_n" />(<xsl:value-of select="./@disp_n" />)
										</OPTION>
										</xsl:for-each>
									</xsl:for-each>		
									</xsl:when>
						...
						<xsl:choose>
							<xsl:when test=".//oi[@tp='12' $and$ ./ad[@iep='1']]" >
							<NOBR>
							<FONT><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_545").text</xsl:eval>:</FONT>
							<BR />
							<SELECT SIZE="1">
								<xsl:attribute name="NAME">Operator_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute>
								<!--for calendar control - to append or not -->
										<xsl:choose>
											<xsl:when expr="this.selectSingleNode('/mi/inputs/DHTML').text=='1'">
												<xsl:attribute name="onChange">updateOperator('Operator_<xsl:value-of select='ancestor(pif)/@pin' />');</xsl:attribute>
												<xsl:attribute name="ID">Operator_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute>
											</xsl:when>
										</xsl:choose>
								<OPTION VALUE="M17">
									<xsl:if test="context(-2)/current[@op='M17']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_519").text</xsl:eval>
								</OPTION>
								<OPTION VALUE="M44">
									<xsl:if test="context(-2)/current[@op='M44']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_614").text</xsl:eval>
								</OPTION>						
								<OPTION VALUE="M6">
									<xsl:if test="context(-2)/current[@op='M6']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_520").text</xsl:eval>
								</OPTION>
								<OPTION VALUE="M7">
									<xsl:if test="context(-2)/current[@op='M7']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_612").text</xsl:eval>
								</OPTION>						
 								<OPTION VALUE="M8">
 									<xsl:if test="context(-2)/current[@op='M8']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
 									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_521").text</xsl:eval>
								</OPTION>
								<OPTION VALUE="M10">
									<xsl:if test="context(-2)/current[@op='M10']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_522").text</xsl:eval>
								</OPTION>
								<OPTION VALUE="M9">
									<xsl:if test="context(-2)/current[@op='M9']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_523").text</xsl:eval>
								</OPTION>
								<OPTION VALUE="M11">
									<xsl:if test="context(-2)/current[@op='M11']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_524").text</xsl:eval>
								</OPTION>
								<OPTION VALUE="M18">
									<xsl:if test="context(-2)/current[@op='M18']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
									<xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_525").text</xsl:eval>
									<xsl:if test=".[@datetime='1']"><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_611").text</xsl:eval></xsl:if>
								</OPTION>
								<OPTION VALUE="M43">
									<xsl:if test="/context(-2)/current[@op='M43']">
										<xsl:attribute name="SELECTED">1</xsl:attribute>
									</xsl:if>
							...
							<xsl:attribute name="NAME">Input_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute>
							</INPUT>
						...
						<xsl:choose>
							<xsl:when expr="this.selectSingleNode('/mi/inputs/DHTML').text=='1'">
								...
								<IMG ALIGN="top" SRC="Images/calendar.gif" STYLE="cursor: hand;" >
									<xsl:attribute name="ID">Calendar_button_<xsl:value-of select='ancestor(pif)/@pin' /></xsl:attribute>
									<xsl:attribute name="onClick">showCalendar(getMonth('Input_<xsl:value-of select='ancestor(pif)/@pin' />'),getYear('Input_<xsl:value-of select='ancestor(pif)/@pin' />'),'Input_<xsl:value-of select='ancestor(pif)/@pin' />',getObjSumLeft('Calendar_button_<xsl:value-of select='ancestor(pif)/@pin' />')-100, (getObjSumTop('Calendar_button_<xsl:value-of select='ancestor(pif)/@pin' />')+getObjHeight('Calendar_button_<xsl:value-of select='ancestor(pif)/@pin' />')));</xsl:attribute>
								</IMG>
								<SCRIPT language="JavaScript">
									createDivForCalendar();
									showOrHideCalendarButton('Attribute_<xsl:value-of select='ancestor(pif)/@pin' />','Calendar_button_<xsl:value-of select='ancestor(pif)/@pin' />');
									updateOperator('Operator_<xsl:value-of select='ancestor(pif)/@pin' />');
								</SCRIPT>
							</xsl:when>
						</xsl:choose>
							
							<BR />
							</NOBR><IMG SRC="Images/1ptrans.gif" WIDTH="1" HEIGHT="74" ALT="" BORDER="0" />
							</xsl:when>
							<xsl:otherwise>
								<BR /><FONT COLOR="#000000"><xsl:attribute name="FACE"><xsl:eval>this.selectSingleNode("/mi/inputs/FontFamily").text</xsl:eval></xsl:attribute><xsl:attribute name="SIZE"><xsl:eval>this.selectSingleNode("/mi/inputs/smallFont").text</xsl:eval></xsl:attribute><xsl:eval no-entities="1">this.selectSingleNode("/mi/inputs/Desc_554").text</xsl:eval><BR /><BR /><BR /></FONT>
							</xsl:otherwise>
