...
Dim sConfirmed
    ...
    If lErr = NO_ERR Then
        ...
        If sConfirmed = "yes" Then
            ...
            lErr = DeleteServiceConfig(aSvcConfigInfo)
    ...
    aPageInfo(S_TITLE_PAGE) = STEP_SERVICES_OVERVIEW & " " & "Overview"
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" HEIGHT="100%">
  ...
  <TR>
    ...
    <TD WIDTH="96%" valign="TOP">
      ...
      <%Else%>
      <BR />
      <FONT FACE="Verdana,Arial,MS Sans Serif"  COLOR="#ff0000"><DIV STYLE="display:none;" class="validation" id="validation"></DIV></FONT>

      <TABLE BORDER="0" WIDTH="100%" CELLSPACING="0" CELLPADDING="0">
        <FORM ACTION="delete_serviceconfig.asp" METHOD="POST">
        <% RenderSvcConfigInputs(aSvcConfigInfo) %>
          <TR>
            <TD>
              <FONT FACE="Verdana,Arial,MS Sans Serif" SIZE="<%=aFontInfo(N_MEDIUM_FONT) %>">
                Are you sure you want to clear the configuration of: <B><%=aSvcConfigInfo(SVCCFG_SVC_NAME)%></B>?
              </FONT>
            </TD>
          </TR>
          <TR>
