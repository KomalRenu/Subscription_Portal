...
<TABLE WIDTH="157" BORDER="0" CELLSPACING="0" CELLPADDING="0">
  <TR>
    ...
    <TD WIDTH="99%" BGCOLOR="#999999"><FONT FACE="<%=aFontInfo(S_FAMILY_FONT)%>" SIZE="1" COLOR="#FFFFFF"><B><%Response.write(asDescriptors(580))'Descriptor:Site Preferences%>:</B><BR /><%=Server.HTMLEncode(Application.Value("SITE_NAME"))%></FONT></TD>
  </TR>
</TABLE>
...
<TR>
  ...
  <TD VALIGN="TOP">
    <%
		Call renderSitePreferencesToolbar()
    %>
  </TD>
