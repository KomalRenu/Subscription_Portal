...
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0">
	<TR><TD COLSPAN="2">
		<FONT FACE="<%Response.Write aFontInfo(S_FAMILY_FONT)%>" SIZE="<%Response.Write aFontInfo(N_SMALL_FONT)%>"><B><%Response.Write asDescriptors(288) 'Descriptor: Select a Day:%></B></FONT>
	</TD></TR>
	<%
	sDayField = "<TR><TD><FONT FACE=""" & aFontInfo(S_FAMILY_FONT) & """ SIZE=""" & aFontInfo(N_SMALL_FONT) & """>&nbsp;&nbsp;&nbsp;" & asDescriptors(290) & "&nbsp;&nbsp;</FONT></TD>" 'Descriptor: Day
	...
	sMonthField = "<TR><TD><FONT FACE=""" & aFontInfo(S_FAMILY_FONT) & """ SIZE=""" & aFontInfo(N_SMALL_FONT) & """>&nbsp;&nbsp;&nbsp;" & asDescriptors(289) & "&nbsp;&nbsp;</FONT></TD>" 'Descriptor: Month
	...
	sYearField = "<TR><TD><FONT FACE=""" & aFontInfo(S_FAMILY_FONT) & """ SIZE=""" & aFontInfo(N_SMALL_FONT) & """>&nbsp;&nbsp;&nbsp;" & asDescriptors(291) & "&nbsp;&nbsp;</FONT></TD>" 'Descriptor: Year
